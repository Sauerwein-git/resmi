      ...
      <div className={styles.background}>
        <div className={styles.section}>
          <div className={styles.smallTag}>
            <span className="red">Работаем в долгую:</span> средний срок
            сотрудничества <br className="mob" />
            &gt; 24 месяцев
          </div>
          ...
          <div className={styles.block}>
            <div className={styles.leftBlock}>
              <div style={{ maxWidth: "586px" }}>
                Залог результата работы – эффективная стратегия на страте
                <br className="mob" /> и фокус в работе на конкретную цель
              </div>
            </div>
            <div className={styles.rightBlock}>
              <div className={styles.textRightBlock}></div>
