...
export const casePreviews: { [key: number]: CasePreview } = {
  1: {
    ...
    storyText:
      "Увеличили прибыль клиента на 30%, а выручку - до 53 000 000 миллионов рублей за 4 месяца.",
    tellText:
  ...
  2: {
    ...
    tellText:
      "Рассказываем, как мы это сделали<br /> с помощью оптимизации рекламы<br /> и глубокой аналитики",
  },
  3: {
  ...
  6: {
    ...
    image: "/img/yandexDirect.png",
    resultText: "ТОП-3 в Яндексе",
    summaryText: "и снижение цены лида в 2,4 раза за год работы с SEO",
    storyText:
