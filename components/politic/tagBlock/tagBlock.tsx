      ...
      <div className={`${styles.background} `}>
        <div className={styles.section}>
          ...
          <div className={styles.text}>
            ...
            данных, предпринимаемые Михайловым Иваном
            <br />
            ...
            данных (далее — Политика) применяется ко всей
            <br />
            информации, которую Оператор может получить о посетителях
            веб-сайта https://research-it.ru 2. Основные понятия, используемые
            в Политике
            <br />
            ...
            совокупность действий (операций), совершаемых
            <br />
            ...
            <br />
            Пользователю веб-сайта https://research-it.ru
            <br />
            ...
            веб-сайта https://research-it.ru
            <br />
            ...
            субъекта персональных данных при наличии оснований, указанных
            ...
            <br />
            6. Цели обработки персональных <br />
            ...
            Оператора privacy@thismywebsite·com с пометкой «Актуализация
            персональных данных».
            <br />
            ...
            Оператора privacy@thismywebsite·com с пометкой «Отзыв согласия
            ...
            к Оператору с помощью электронной почты privacy@thismywebsite·com.
            <br />
            ...
            в сети Интернет по адресу https://research-it.ru/politic.
            <br />
          </div>
        </div>
      </div>
