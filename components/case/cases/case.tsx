      ...
      <div className={styles.background}>
        <div className={styles.section}>
          <div className={styles.prevButton}>
            <div className={`custom-prevFive_Free ${styles.navButtonWrapper}`}>
              <Image
            ...
            <div className={`custom-nextFive_Free ${styles.navButtonWrapper}`}>
              <Image
      ...
      {activeModalId !== null && caseData[activeModalId] && (
        ...
        >
          ...
          >
            ...
            {caseData[activeModalId].bottomImage && (
              <div className={styles.modalBottomImage}>
                <Image
                  src={caseData[activeModalId].bottomImage!}
                  alt={`Иллюстрация к кейсу ${caseData[activeModalId].title}`}
                  width={800}
                  height={400}
            ...
            {/* НОВЫЙ БЛОК: изображение в самом низу */}
          </div>
        </div>
      )}
    </>
